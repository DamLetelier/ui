...
<head>
    ...
    <title>Modificar Apoderado</title>
    ...
    <nav id="nav_f" class="default_color" role="navigation">
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul class="right">
                    <li><a href="aporeg.php"><span class="mdi-action-account-circle"></span>    Registrar</a></li>
...
if(isset($_POST['btnmod'])){
    ...
    $u->modicarapoderado($rut,$nom, $ape, $fon, $pass, $dir, $pag,$cau);
    $rs="";
    $rut="";
    $nom="";
    $ape = "";
        ...
        <div class="row">
            <div  class="col s12">
                <div class="input-field col s12">
                    <form id="form1" name="form1" method="post" action="apomod.php">

                        <input  id="consulta" name="consulta" type="text" class="validate" required value="<?php echo $rut;?>">


                        <label for="consulta">Ingresar Rut del Apoderado</label>
            ...
            <div class="row">
                <form id="form2" name="form2" method="post" action="apomod.php">
                    <div class="col s12">
                        <div class="row">
                        ...
                        <form class="col s12" id="form1" name="form1" method="post" action="asisreg.php" >
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="txtpago" type="number" name="txtpago" class="validate" value="<?php echo $pag;?>">
                                    <label for="txtpago">Informacion Adicional</label>
                                </div>
