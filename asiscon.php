...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            ...
            <form id="form1" name="form1" method="post" action="asiscon.php">
            ...
            <table id="tabla" class="striped">
                ...
                <tr style="border: 2px solid blue">
                    ...
                    <th style="border: 2px solid blue">ARCHIVO</th>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <a  class="btn waves-effect default_color col s12"  onclick="window.print();" >Imprimir Consulta</a>
                </div>
            </div>
        </div>
    </div>
