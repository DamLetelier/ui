...
if(isset($_POST['btnmod'])){
    ...
    $u->modificarchoferes($rut, $nom, $ape,$dir,$pass,$fon,$info,$pat,$cau);
    $rs="";
    $rut="";
    $nom="";
    $ape = "";
        ...
        <div class="row">
            <div  class="col s12">
                <div class="input-field col s12">
                    <form id="form1" name="form1" method="post" action="chofmod.php">

                        <input  id="consulta" name="consulta" type="text" class="validate" required value="<?php echo $rut;?>">


                        <label for="consulta">Ingresar Rut de Chofer</label>
            ...
            <div class="row">
                <form id="form2" name="form2" method="post" action="chofmod.php">
                    <div class="col s12">

                        <form class="col s12" id="form1" name="form1" method="post" action="chofreg.php" >
                            <div class="row">
