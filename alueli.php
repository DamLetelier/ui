    ...
    <div id="intro" class="section scrollspy">
        <div class="container">
            <div class="row">
                ...
                <form id="form1" name="form1" method="post" action="alueli.php">
                    <div class="input-field col s6">
                        ...
                        <br><br><br><br><br><br>
                        <label for="consulta">Ingrese rut del Alumno</label>
                    </div>
                    <br>
                </form>
                <br>
                <br>
                <table id="tabla" ">
                <caption style="font-size: large">LISTADO DE ALUMNOS</caption>
                <tr style="border: 2px solid blue">
                    ...
                    <th style="border: 2px solid blue">FECHA DE NACIMIENTO</th>
                    <th style="border: 2px solid blue">DIRECCION</th>
                    <th style="border: 2px solid blue">APODERADO</th>
                    <th style="border: 2px solid blue">COLEGIO</th>
                    <th style="border: 2px solid blue">DESVINCULACION</th>
