    ...
    <div class="container">
        <div class="row" id="intro">
            ...
            <div  class="col s12">
                ...
                <div class="diomio" id="diomio" align="center">
                    <a class="btn" onclick="Materialize.toast('El bus no se encuentra activo', 4000, 'rounded')">Ver Mapa</a>
                </div>
...
<div class="parallax-container">
    ...
    <div class="col 13 s12" align="right">
        <h4 class="center header text_h2"><span class="span_h2"><span class="mdi-action-visibility-off"></span><a href="gpsbusno.html">Fuera de Línea</a></span></h4>
    </div>
</div>
