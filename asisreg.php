...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            <div class="row">
                <form class="col s12" id="form1" name="form1" method="post" action="asisreg.php" enctype="multipart/form-data">
            ...
            if(isset($_POST['btnreg'])){
                ...
                $u->regasis($rut,$nom,$ape,$dir,$pass,$fon,$info,$pat,$nombre_img);
                $u->regusuasis($rut,$pass);
            }
            ?>
