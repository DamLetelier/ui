...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            ...
            <form id="form1" name="form1" method="post" action="pagmod.php">
            ...
            <caption style="font-size: large">LISTADO DE APODERADOS MOROSOS </caption>
            <tr  class="card-panel waves-red">
                <th >RUT</th>
                <th >NOMBRE</th>
                <th >APELLIDO</th>
                <th>TELEFONO</th>
                <th >PAGO</th>
                <th >ABONO A LA FECHA</th>
                <th>DEUDA TOTAL A LA FECHA</th>
